...
try {
    ...
    $result = $conn->prepare("SELECT userid, pName, pDesc, dDate, mDate, date1, date2, date3,
...
foreach ($rows as $row) {
    ...
    <div class="milestone-container">
        ...
        <input type="checkbox" name="mDate" value="date1"><?php echo $date1 ?><br>
        <input type="checkbox" name="mDate" value="date2"><?php echo $date2 ?><br>
        <input type="checkbox" name="mDate" value="date3"><?php echo $date3 ?><br>
        <input type="checkbox" name="mDate" value="date4"><?php echo $date4 ?><br>
        <input type="checkbox" name="mDate" value="date5"><?php echo $date5 ?><br>
        </div>
        <div class="dateContainerRight">
        <input type="checkbox" name="mDate" value="date6"><?php echo $date6 ?><br>
        <input type="checkbox" name="mDate" value="date7"><?php echo $date7 ?><br>
        <input type="checkbox" name="mDate" value="date8"><?php echo $date8 ?><br>
        <input type="checkbox" name="mDate" value="date9"><?php echo $date9 ?><br>
        <input type="checkbox" name="mDate" value="date10"><?php echo $date10 ?><br>
        </div>
        <br><br><br><br>
